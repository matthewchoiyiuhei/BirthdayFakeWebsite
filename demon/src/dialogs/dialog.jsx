...
export default class Dialog extends Component {
  ...
  render() {
    ...
    .scheme('enter')
      .setProperty('main', { x: -1920, alpha: 0 })
      .parallel()
    ...
    .scheme('leave')
      .parallel()
      .moveTo('main', { x: -1920 }, 300, Tween.Easing.Cubic.In)
    ...
    return (
      <Tween schemes={schemas} ref={tween => (this.tween = tween)}>
        <_Dialog width={1920} height={1080} alpha={this.state.alpha} dragable={false} key='main'>

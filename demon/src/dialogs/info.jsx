...
export default class Info extends Component {
  ...
  render() {
    const TEXT = `
A Future-oriented Adventure Game Development Framework.

Github: https://github.com/avgjs

©2015 Icemic, bakery.moe
...
limitations under the License.
    ...
    return (
      <Dialog>
        <Layout
          baseline={0} direction='vertical' maxHeight={470} maxWidth={1000} clip={true}
          x={170} y={200} overflowX='hidden' overflowY='scroll' scrollStyle={scrollStyle}
